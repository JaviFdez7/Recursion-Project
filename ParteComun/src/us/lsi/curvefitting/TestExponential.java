...
public class TestExponential {
	...
	public static void main(String[] args) {
		...
		DataCurveFitting.testFileExponential("ficheros/datos_exponential.txt");
		List<WeightedObservedPoint> points = DataCurveFitting.points("ficheros/datos_exponential.txt");		
